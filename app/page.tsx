        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 px-5 py-16 sm:px-6 sm:py-20 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:py-24">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href="/book-opd"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-[var(--foreground)] px-6 py-3.5 text-sm font-bold text-[var(--background)] shadow-sm hover:-translate-y-0.5 hover:opacity-90"
              >
                Book an OPD
                <span>→</span>
              </a>
              ...
              <a
                href="/register"
                className="inline-flex items-center justify-center rounded-xl border border-[var(--border-strong)] bg-[var(--surface)] px-6 py-3.5 text-sm font-bold text-[var(--foreground)] hover:-translate-y-0.5 hover:border-[var(--primary)]"
              >
                Start Your Journey
              </a>
