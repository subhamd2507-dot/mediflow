  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <section className="relative overflow-hidden">
        ...
        {/* Background glow */}
        <div className="pointer-events-none absolute left-[-140px] top-[120px] h-[420px] w-[420px] rounded-full bg-[var(--primary-soft)] opacity-30 blur-[120px]" />
        ...
        <div className="relative mx-auto grid min-h-[570px] max-w-7xl items-center gap-10 px-5 py-14 sm:px-6 sm:py-16 lg:grid-cols-[0.95fr_1.05fr] lg:gap-6 lg:px-8 lg:py-20">
          ...
          {/* =====================================================
              LEFT — HERO CONTENT
          ====================================================== */}
          <div className="relative z-20 max-w-2xl lg:pr-6">
            ...
            <div className="mt-8 grid max-w-xl gap-3 text-sm text-[var(--foreground-muted)] sm:grid-cols-3">
              ...
              <div className="flex items-center gap-2">
                <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[var(--success-soft)]">
                  ✓
                </span>
                Simple to use
              </div>
          ...
          ====================================================== */}
          <div className="group relative min-h-[500px] lg:min-h-[560px]">
            ...
            <div className="pointer-events-none absolute right-[5%] top-[8%] h-44 w-44 rounded-full bg-[var(--accent-glow)] blur-[80px]" />

            <div className="pointer-events-none absolute bottom-[5%] right-[12%] h-52 w-52 rounded-full bg-[var(--violet-glow)] blur-[90px]" />


            {/* =================================================
                PATIENT WORKSPACE CARD
            ================================================== */}
            <div className="absolute left-1/2 top-1/2 z-20 w-full max-w-[520px] -translate-x-1/2 -translate-y-1/2 lg:left-[52%]">

              <div className="rounded-[28px] border border-[var(--border)] bg-[var(--surface)] p-4 shadow-2xl sm:p-5">
              ...
              {/* Floating label */}
              <div className="absolute -bottom-6 -left-3 hidden rounded-2xl border border-[var(--border)] bg-[var(--surface)] px-4 py-3 shadow-lg sm:block">
